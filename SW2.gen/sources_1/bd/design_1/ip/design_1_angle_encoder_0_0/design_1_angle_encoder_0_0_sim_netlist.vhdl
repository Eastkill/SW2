...
--               c:/Users/lab/Desktop/SpaceWar/SW2/SW2.gen/sources_1/bd/design_1/ip/design_1_angle_encoder_0_0/design_1_angle_encoder_0_0_sim_netlist.vhdl
...
entity design_1_angle_encoder_0_0_angle_encoder is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_angle_encoder_0_0_angle_encoder : entity is "angle_encoder";
end design_1_angle_encoder_0_0_angle_encoder;

architecture STRUCTURE of design_1_angle_encoder_0_0_angle_encoder is
  ...
  signal \angle_reg[3]_i_3_n_0\ : STD_LOGIC;
  signal \angle_reg[3]_i_4_n_0\ : STD_LOGIC;
  ...
  signal rot_r_delayed_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \angle_reg[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \angle_reg[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \angle_reg[3]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \angle_reg[4]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \angle_reg[4]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of rot_r_delayed_i_1 : label is "soft_lutpair2";
begin
  ANG(3 downto 0) <= \^ang\(3 downto 0);
  \angle_reg_reg[3]_0\ <= \^angle_reg_reg[3]_0\;
\angle_reg[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2F"
    )
        port map (
...
\angle_reg[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D37C"
    )
        port map (
...
\angle_reg[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"54D5"
    )
        port map (
...
\angle_reg[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\angle_reg[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4440404040404042"
    )
        port map (
      I0 => ROT_L,
      I1 => \^ang\(3),
...
\angle_reg[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAEAA"
    )
        port map (
...
\angle_reg[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\angle_reg[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AE"
    )
        port map (
...
rot_r_delayed_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_angle_encoder_0_0 is
  port (
    ROT_L : in STD_LOGIC;
    ROT_R : in STD_LOGIC;
    RST : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_angle_encoder_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_angle_encoder_0_0 : entity is "design_1_angle_encoder_0_0,angle_encoder,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_angle_encoder_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_angle_encoder_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_angle_encoder_0_0 : entity is "angle_encoder,Vivado 2025.1";
end design_1_angle_encoder_0_0;

architecture STRUCTURE of design_1_angle_encoder_0_0 is
...
begin
inst: entity work.design_1_angle_encoder_0_0_angle_encoder
     port map (
      ANG(3) => ANG(4),
