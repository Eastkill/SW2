...
module design_1
  ...
  design_1_EnemyController_0_0 EnemyController_0
       (.Clk(TickGenerator_0_FrameTick),
        ...
        .HIT(EnemyController_0_HIT),
        .RstN(PL_USER_PB0));
  design_1_GameController_0_0 GameController_0
       (.Clk(clk_wiz_0_clk25),
        .Health(PL_USER_LED),
        .RstN(PL_USER_PB0),
        .hit(EnemyController_0_HIT));
