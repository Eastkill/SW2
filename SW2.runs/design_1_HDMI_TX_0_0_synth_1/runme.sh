...
HD_PWD='C:/Users/lab/Desktop/SpaceWar/SW2/SW2.runs/design_1_HDMI_TX_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HDMI_TX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HDMI_TX_0_0.tcl
